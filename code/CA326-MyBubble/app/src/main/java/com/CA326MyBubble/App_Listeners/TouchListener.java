package com.CA326MyBubble.App_Listeners;
...
// Handles using the floating action button and clicking news articles in Dashboard and News Page, to avoid going to a different fragment/page
